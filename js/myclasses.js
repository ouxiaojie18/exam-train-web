$(document).ready(function () {
    ...
    getCourseLeft = (item, index) => {//, num, video_num
        $.ajax({
    ...
    getCourseRight = (item, index, index1) => {//,num, course_info
        $.ajax({
            url: "https://kaopeixia.com/webapi/coursedetail/getcoursedetailbycourselistid",
            type: "GET",
            async: false,
            data: {
                "user_id": uid,
